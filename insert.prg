...
PARAMETERS lcdocno 
	...
	*MESSAGEBOX(lcdocno,64,'เลขที่เอกสารใหม่')
	 ...
	 lccommand = lccommand + " case e.taxtype when 0 then 'แยกนอก' when 1 then 'รวมใน' when 2 then 'อัตราศูนย์' end as taxtypedesc,e.taxtype,e.taxrate,e.beforetaxamount,e.taxamount,e.netdebtamount as totalamount ,e.taxno, "
